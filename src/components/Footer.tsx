        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-orange-400">Envíos</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-orange-400"><Facebook className="h-6 w-6" /></a>
              <a href="#" className="hover:text-orange-400"><Twitter className="h-6 w-6" /></a>
              <a href="#" className="hover:text-orange-400"><Instagram className="h-6 w-6" /></a>
            </div>
          </div>
        </div>
